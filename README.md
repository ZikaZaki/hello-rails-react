...
**Hello-Rails-React** project implements a connection between a Ruby on Rails back-end and React front-end.
...
```sh
  git clone git@github.com:ZikaZaki/hello-rails-react.git
```
